...
export default function ShopOnboarding() {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    if (!shopName.trim() || !phone.trim() || !location.trim()) {
      alert('Please fill in shop name, phone, and location')
      return
    }
    ...
    // Static submission – later connect to real API
    console.log('Shop Onboarding Data:', {
      shop_name: shopName,
      phone,
      location,
    ...
    alert('Shop registered successfully! Welcome to Zaprint 🎉')
    navigate('/dashboard')
  }
        ...
        <CardContent>
          <form onSubmit={handleSubmit} className="space-y-8">
            ...
            <div className="space-y-2">
              ...
              <Textarea
                id="location"
                placeholder="Full address where students can visit (include landmarks)"
                rows={3}
                value={location}
